...
import { Card, Form, Input, Button, Select, Row, Col, Breadcrumb, message, Spin } from 'antd'
import { Link } from 'react-router-dom'
import SimpleMDE from 'react-simplemde-editor'
import { reqTagList, reqCategoryList, reqUpdateArticle, reqArticleDetail } from '../../request'
...
export default class Edit extends Component {
  ...
  initForm = async() => {
    ...
    if (result.status === 1) {
      ...
      this.form.current.setFieldsValue({title, img_url, desc, content, visible, tags, category, origin})
    }
  }
            ...
            <Row>
              <Col span={8}>
                <Form.Item
                  ...
                  style={{paddingRight: 10}}
                >
                  <Select mode="multiple">{/* mode="multiple"，支持多选 */}
                    {
                      tagList.map((item) => 
